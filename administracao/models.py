...
class Servico(models.Model):
    ...
    valor_minimo = models.IntegerField(null=False, blank=False)
    ...
    icone = models.CharField(null=False, blank=False, choices=ICONE_CHOICES, max_length=14) #opcoes de icones
